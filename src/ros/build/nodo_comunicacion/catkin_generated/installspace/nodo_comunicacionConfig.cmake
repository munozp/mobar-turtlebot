...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'nodo_comunicacion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gsi/Escritorio/mobar/src/ros/install/${idir}'.  Ask the maintainer 'turtle <turtle@todo.todo>' to fix it.")
    endif()
