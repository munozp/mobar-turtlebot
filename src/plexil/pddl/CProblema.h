...
#define AUX "aux"
/** Linea a partir de la cual se pueden insertar todos los predicados que se deseen*/
#define CONFIG ";DATA AND CONFIG"
/**      */
#define OBJS "(:objects"
...
{
    public:
        /** Constructor de la clase, inicializa las lineas de inicio de estados iniciales y metas del ficher PDDL. Si no se indican, toma valores por defecto (:init y (:goal(and.
        ...
        */
        ...
        /** Elimina los objetivos (goals) del problema, dejando las lineas "(:goal" y cierre ")".
         * @return False si no se ha podido abrir algun archivo o no se encuentra la marca de goals.
         */
        bool eliminar_goals();

        /** Elimina un subset de estados iniciales del problema. Dicho subset son todos los estados iniciales contenidos entre (:init y una linea cuyo comienzo sea un comentario (primer caracter ';').
         * @return False si no se ha podido abrir algun archivo o no se encuentra la marca de init.
         */
        bool eliminar_inits();
    ...
    private:
        ...
        /** Linea de inicio de los datos de configuracion iniciales*/
        char configuracion[TAM_LINEA];
