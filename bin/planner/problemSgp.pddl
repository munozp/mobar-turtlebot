...
(:init
(= (distance_to_move C7_4 C7_9) 5.82843)
(= (distance_to_move C7_4 C7_5) 1.00000)
(= (distance_to_move C7_9 C7_4) 5.82843)
(= (distance_to_move C7_9 C7_5) 4.82843)
(= (distance_to_move C7_5 C7_4) 1.00000)
(= (distance_to_move C7_5 C7_9) 4.82843)
(= (distance_to_move C6_5 C7_4) 1.41421)
(= (distance_to_move C6_5 C7_9) 4.41421)
(= (distance_to_move C6_5 C7_5) 1.00000)
(= (square_size) 0.4) ;m
;TURTLEBOT DATA AND CONFIG
(position turtle C6_5)
...
;AUTODOCK
(dock C7_5)
(= (autodocking-time C7_5) 10)
(= (energy_charge C7_5) 0.1)
(= (time_to_charge C7_5) 60)
(= (time_point) 0)
)
;===============================================================================
;OBJECTIVES AND METRIC
(:goal (and
(picture C7_9 turtle highRes P120_120)
(picture C7_4 turtle highRes P80_120)
(is_charging turtle)
)))
